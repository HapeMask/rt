...
/* Line 35 of lalr1.cc  */
#line 57 "../src/scene/sceneparser.y"
...
#line 190 "sceneparser.tab.h"
   ...
   enum yytokentype {
    ...
    Parser (scanner& scan_yyarg, scene& scn_yyarg);
    virtual ~Parser ();
